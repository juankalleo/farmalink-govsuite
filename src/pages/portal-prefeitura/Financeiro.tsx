...
const initial: Transacao[] = [
  { id: 't1', tipo: 'entrada', descricao: 'Reembolso de compra', valor: 12500, data: new Date(), status: 'pendente', referencia: 'NF-123' },
  { id: 't2', tipo: 'saida', descricao: 'Pagamento fornecedor X', valor: 8500, data: new Date(Date.now() - 1000 * 60 * 60 * 24 * 10), status: 'pendente', referencia: 'FAT-987' },
  { id: 't3', tipo: 'entrada', descricao: 'Recebimento convênio', valor: 42000, data: new Date(Date.now() - 1000 * 60 * 60 * 24 * 30), status: 'processada' },
];
...
export default function Financeiro() {
  ...
  return (
    <div>
      <DashboardHeader titulo="Financeiro" subtitulo="Fluxo financeiro e cobranças" />
