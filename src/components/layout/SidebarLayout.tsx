...
const menusPortal: Record<TipoPortal, ItemMenu[]> = {
  prefeitura: [
    ...
    { titulo: 'Tabela de Preços', href: '/portal-prefeitura/fornecedores/precos', icone: <FileText className="h-4 w-4" /> },
  ...
  fornecedor: [
    ...
    { titulo: 'Tabela de Preços', href: '/portal-fornecedor/fornecedores/precos', icone: <FileText className="h-4 w-4" /> },
